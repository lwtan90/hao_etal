...
seuOBJ.markers <- FindMarkers(seuOBJ, assay="SCT", ident.1 = celltype, min.pct = 0.2, logfc.threshold = 0.2, only.pos=TRUE)

## output the de output as a text file
write.table(seuOBJ.markers,file=paste("marker_",celltype,".txt",sep=""),sep="\t",quote=FALSE)
